<div class="h-[calc(100vh-8rem)] bg-slate-100 dark:bg-slate-900 p-4 overflow-auto">
    ...
    <p class="bg-slate-300 dark:bg-slate-600 dark:text-white text-4xl p-4 max-h-48 overflow-auto rounded-2xl">
        ...
        voluptates quaerat, nesciunt laboriosam iure quia tenetur provident exercitationem
        voluptas, quos tempora ratione cumque sint animi consequuntur voluptatem
        accusantium quasi commodi. Sequi culpa reiciendis dolores esse impedit cum magni
        fuga quas deserunt quam distinctio aperiam, accusamus aliquam in. Dolore, vel
        labore! Neque aperiam ex doloribus. Dolore odio numquam, ut illum temporibus
        molestiae accusamus laudantium ipsa blanditiis nesciunt atque illo, maxime, eaque
        voluptatum modi ea dignissimos hic. Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Sed porro suscipit dicta enim recusandae aut veniam, culpa illo
    </p>
</div>
